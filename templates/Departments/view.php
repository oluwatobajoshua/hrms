...
<div class="related related-designations view card">
  <div class="card-header d-sm-flex">
    <h3 class="card-title"><?= __('Related Designations') ?></h3>
    <div class="card-toolbox">
      <?= $this->Html->link(__('New'), ['controller' => 'Designations' , 'action' => 'add'], ['class' => 'btn btn-primary btn-sm']) ?>
      <?= $this->Html->link(__('List '), ['controller' => 'Designations' , 'action' => 'index'], ['class' => 'btn btn-primary btn-sm']) ?>
    </div>
  </div>
  <div class="card-body table-responsive p-0">
    <table class="table table-hover text-nowrap">
      ...
      <?php }else{ ?>
        ...
        <tr>
            ...
            <td class="actions">
              <?= $this->Html->link(__('View'), ['controller' => 'Designations', 'action' => 'view', $designations->id], ['class'=>'btn btn-xs btn-outline-primary']) ?>
              <?= $this->Html->link(__('Edit'), ['controller' => 'Designations', 'action' => 'edit', $designations->id], ['class'=>'btn btn-xs btn-outline-primary']) ?>
              <?= $this->Form->postLink(__('Delete'), ['controller' => 'Designations', 'action' => 'delete', $designations->id], ['class'=>'btn btn-xs btn-outline-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $designations->id)]) ?>
            </td>
        </tr>
        <?php endforeach; ?>
      <?php } ?>
  ...
  <div class="card-body table-responsive p-0">
    <table class="table table-hover text-nowrap">
      ...
      <?php if (empty($department->employees)) { ?>
        <tr>
            <td colspan="67" class="text-muted">
