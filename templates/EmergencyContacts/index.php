...
?>
<?php
$this->assign('title', __('Emergency Contacts'));
...
<div class="card card-primary card-outline">
    <div class="card-header d-sm-flex">
        ...
        <div class="card-toolbox">
            ...
            <?= $this->Html->link(__('New Emergency Contact'), ['action' => 'add'], ['class' => 'btn btn-primary btn-sm']) ?>
        </div>
    </div>
    <!-- /.card-header -->
            ...
            <tbody>
                <?php foreach ($emergencyContacts as $emergencyContact) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(__('View'), ['action' => 'view', $emergencyContact->id], ['class' => 'btn btn-xs btn-outline-primary', 'escape' => false]) ?>
                            <?= $this->Html->link(__('Edit'), ['action' => 'edit', $emergencyContact->id], ['class' => 'btn btn-xs btn-outline-primary', 'escape' => false]) ?>
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $emergencyContact->id], ['class' => 'btn btn-xs btn-outline-danger', 'escape' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $emergencyContact->id)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
