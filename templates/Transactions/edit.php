...
<div class="card card-primary card-outline">
  ...
  <div class="card-body">
    ...
    <?php
      ...
      echo $this->Form->control('employee_id', ['options' => $employees,'disabled' => true]);
      // echo $this->Form->control('company_id', ['options' => $companies]);
      echo $this->Form->control('date',['disabled' => true]);
      echo $this->Form->control('basic_salary',['disabled' => true]);
      ...
      echo $this->Form->control('service_charge',['readonly' => true]);
