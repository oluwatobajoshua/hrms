...
class AttendancesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->allowEmptyString('location_lat');

        $validator
            ->decimal('location_lng')
            ->allowEmptyString('location_lng');

        $validator
            ->scalar('check_in_ip')
            ->maxLength('check_in_ip', 50)
            ->allowEmptyString('check_in_ip');

        $validator
            ->scalar('check_out_ip')
            ->maxLength('check_out_ip', 50)
            ->allowEmptyString('check_out_ip');
