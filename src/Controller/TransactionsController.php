...
class TransactionsController extends AppController
{
    ...
    public function newMonth()
    {
        ...
        foreach($employees as $employeed){
            ...
            $transaction->personal_loan             = round($employeed->pers_loan_rep ? $employeed->pers_loan_rep : 00,2); 
    ...
    public function add($employeeid = null)
    {
        ...
        $employee = $this->Transactions->Employees->find('list')->where(['id IS' => $employeeid]);
    ...
    public function edit($id = null)
    {
        ...
        $employees = $this->Transactions->Employees->find('list')->where(['id' => $transaction->employee_id]);
