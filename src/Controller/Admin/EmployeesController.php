...
class EmployeesController extends AppController
{
    ...
    public function view($id = null)
    {
        $employee = $this->Employees->get($id, [
            'contain' => ['Branches', 'Grades', 'Sections', 'Cadres', 'Banks', 'Genders', 'Religions', 'Locals', 'PhysicalPostures', 'MaritalStatuses', 'HighestEducations', 'Designations', 'Statuses', 'Users', 'Addresses', 'ChildrenDetails', 'Educations', 'Leaves', 'NextOfKins', 'OtherDepartments', 'Transactions', 'WorkDetails'],
        ]);
